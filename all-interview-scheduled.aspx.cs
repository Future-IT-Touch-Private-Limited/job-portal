...
public partial class adm_all_interview_scheduled : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_exam_interview where post_type=@post_type ORDER BY sr DESC";
