<%@ Page Title="All Submitted News" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-news.aspx.cs" Inherits="adm_staff_member_news" %>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td class="w-10"><%# Eval("meta_title") %> <br />
                                                                        <a href='https://agovtjobs.in/news/<%# Eval("page_short_url") %>' style="font-size: small; color: blue" target="_blank">https://agovtjobs.in/news/<%# Eval("page_short_url") %></a>
                                                                    </td>
