<%@ Page Title="" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-private-jobs.aspx.cs" Inherits="adm_staff_member_private_jobs" %>
                            ...
                            <div class="card r-0 no-b shadow2">
                                <div class="shadow p-4 bg-light">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:Button ID="deleteitem" CssClass="btn btn-sm btn-danger" OnClick="deleteitem_Click" CommandArgument='<%#Eval("sr") %>' runat="server" Text="Delete Selected" />&nbsp;&nbsp;
                                                <br />
                                                <br />
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="submitted_by_lbl" runat="server" Text='<%# Eval("submitted_username") %>'></asp:Label><br />
                                                                        <%# Eval("submitted_date") %>
                                                                    </td>
                                                                    <td class="w-10"><%# Eval("sch_industry") %> Jobs - Apply for <%# Eval("sch_number_of_posts") %> <%# Eval("sch_post_name") %> Jobs in <%# Eval("district") %></td>
