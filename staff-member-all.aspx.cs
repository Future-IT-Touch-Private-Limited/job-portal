...
public partial class adm_staff_member_all : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_staff where status=@status ORDER BY sr DESC";
    ...
    {
        Label sr_lbl = (Label)e.Item.FindControl("usernamelbl");
