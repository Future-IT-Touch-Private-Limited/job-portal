...
public partial class adm_staff_member_admit_cards : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_admitcards where post_status=@post_status ORDER BY sr DESC";
    ...
    protected void deleteitem_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem Item in Repeater1.Items)
        {
            ...
            if (chkDelete.Checked)
            {
                ...
                con4.Open();
                string strcon4 = "delete from job_site_admitcards where sr=@sr";
