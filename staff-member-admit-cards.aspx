<%@ Page Title="All Admit Cards by Staff Members" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-admit-cards.aspx.cs" Inherits="adm_staff_member_admit_cards" %>
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td>
                                                                        <a class="btn-fab btn-fab-sm btn-primary text-white" href='edit-admit-cards.aspx?id=<%# Eval("sr") %>'>
