<%@ Page Title="All Submitted Written Marks" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-written-marks.aspx.cs" Inherits="adm_staff_member_written_marks" %>
                            ...
                            <div class="card r-0 no-b shadow2">
                                <div class="shadow p-4 bg-light">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:Button ID="deleteitem" CssClass="btn btn-sm btn-danger" OnClick="deleteitem_Click" CommandArgument='<%#Eval("sr") %>' runat="server" Text="Delete" />
                                                <br />
                                                <br />
                                                <table class="table table-bordered table-hover">
                                                    <thead>
                                                        <tr class="no-b">
                                                            ...
                                                            <td class="bolder">
                                                                <span style="color: black">&nbsp;Subitted By</span>
                                                            </td>
                                                            <td class="bolder">
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="submitted_by_lbl" runat="server" Text='<%# Eval("submitted_username") %>'></asp:Label>
                                                                    </td>
                                                                    <td class="w-10"><%# Eval("sch_industry") %>, <%# Eval("sch_post_name") %> - <%# Eval("state") %>
                                                                        <br />
                                                                    ...
                                                                    <td>
                                                                        <a class="btn-fab btn-fab-sm btn-primary text-white" href='edit-answer-keys.aspx?id=<%# Eval("sr") %>'>
