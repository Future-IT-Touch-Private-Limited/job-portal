<%@ Page Title="Add Post" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="add-post.aspx.cs" Inherits="adm_add_post" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <br />
                                <asp:Button ID="publish_post" OnClick="publish_post_Click" CssClass="btn btn-sm btn-dark" runat="server" Text="Publish Post" />&nbsp;
                        <asp:Button ID="draft_post" OnClick="draft_post_Click" CssClass="btn btn-sm btn-default" runat="server" Text="Send to Draft" /><br />
                            </div>
