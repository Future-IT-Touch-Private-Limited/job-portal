...
public partial class adm_all_posts : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_posts ORDER BY sr DESC";
    ...
    protected void searchbtn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strcon = "select top 150 * from job_site_posts where page_full_url like '%'+@search_query+'%' or main_category like '%'+@search_query+'%' or sub_category like '%'+@search_query+'%' or sch_industry like '%'+@search_query+'%' or sch_number_of_posts like '%'+@search_query+'%'";
