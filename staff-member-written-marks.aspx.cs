...
public partial class adm_staff_member_written_marks : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_extra_posts where post_status=@post_status and post_type=@post_type ORDER BY sr DESC";
        cmd = new SqlCommand(strcon, con);
        cmd.Parameters.AddWithValue("@post_status", "Submitted");
        cmd.Parameters.AddWithValue("@post_type", "Written Marks");
    ...
    protected void deleteitem_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem Item in Repeater1.Items)
        {
            ...
            if (chkDelete.Checked)
            {
                ...
                con4.Open();
                string strcon4 = "delete from job_site_extra_posts where sr=@sr";
