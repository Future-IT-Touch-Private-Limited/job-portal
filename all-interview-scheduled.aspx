<%@ Page Title="All Interview Scheduled" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="all-interview-scheduled.aspx.cs" Inherits="adm_all_interview_scheduled" %>
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td>
                                                                        <a class="btn-fab btn-fab-sm btn-primary text-white" href='edit-extraposts.aspx?id=<%# Eval("sr") %>'>
