<%@ Page Title="All Submitted Syllabus" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-syllabus.aspx.cs" Inherits="adm_staff_member_syllabus" %>
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td>
                                                                        <a class="btn-fab btn-fab-sm btn-primary text-white" href='edit-admitcard.aspx?id=<%# Eval("sr") %>'>
