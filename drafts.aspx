<%@ Page Title="Drafts" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="drafts.aspx.cs" Inherits="adm_drafts" %>
                            ...
                            <div class="card r-0 no-b shadow2">
                                <div class="shadow p-4 bg-light">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:Button ID="deleteitem" OnClick="deleteitem_Click" CommandArgument='<%#Eval("sr") %>' runat="server" Text="Delete Selected" />
                                                <asp:Button ID="publishselectedbtn" OnClick="publishselectedbtn_Click" CommandArgument='<%#Eval("sr") %>' runat="server" Text="Publish Selected" />
                                                <br />
                                                <br />
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td class="w-10"><%# Eval("sch_industry") %> Jobs - Apply for <%# Eval("sch_number_of_posts") %> <%# Eval("sch_post_name") %> Jobs in <%# Eval("district") %><br />
