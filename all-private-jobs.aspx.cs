...
public partial class adm_all_private_jobs : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from job_site_posts where main_category=@main_category ORDER BY sr DESC";
    ...
    protected void searchbtn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strcon = "select top 150 * from job_site_posts where page_full_url like '%'+@search_query+'%' or main_category like '%'+@search_query+'%' or sub_category like '%'+@search_query+'%' or sch_industry like '%'+@search_query+'%' or sch_number_of_posts like '%'+@search_query+'%' and main_category=@main_category";
            SqlCommand cmd = new SqlCommand(strcon, con3);
            cmd.Parameters.AddWithValue("@search_query", searchtxt.Text.Trim().ToString());
            cmd.Parameters.AddWithValue("@main_category", "Private Jobs");
