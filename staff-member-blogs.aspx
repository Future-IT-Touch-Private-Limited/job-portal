<%@ Page Title="All Submitted Blogs" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="staff-member-blogs.aspx.cs" Inherits="adm_staff_member_blogs" %>
                                                        ...
                                                        <asp:Repeater ID="Repeater1" runat="server">
                                                            <ItemTemplate>
                                                                <tr class="black-text">
                                                                    ...
                                                                    <td><%# Eval("post_status") %></td>
                                                                    <td class="w-10"><%# Eval("meta_title") %> <br />
                                                                        <a href='https://agovtjobs.in/blog/<%# Eval("page_short_url") %>' style="font-size: small; color: blue" target="_blank">https://agovtjobs.in/blog/<%# Eval("page_short_url") %></a>
                                                                    </td>
                                                                    <td><%# Eval("main_category") %></td>
                                                                    <td>
                                                                        <a class="btn-fab btn-fab-sm btn-primary text-white" href='edit-news-blog.aspx?id=<%# Eval("sr") %>'>
