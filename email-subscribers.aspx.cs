...
public partial class adm_email_subscribers : System.Web.UI.Page
{
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    ...
    DataTable GetData()
    {
        ...
        SqlConnection con = new SqlConnection(DecryptString(System.Configuration.ConfigurationManager.AppSettings["cn2"], EncryptionKey2));
        string strcon = "select * from job_site_subs ORDER BY sr DESC";
        cmd = new SqlCommand(strcon, con);
        //cmd.Parameters.AddWithValue("@queryemail", Request.Cookies["li"]["cmpun"].ToString());
    ...
    protected void deleteitem_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem Item in Repeater1.Items)
        {
            ...
            if (chkDelete.Checked)
            {
                ...
                SqlConnection con4 = new SqlConnection(DecryptString(System.Configuration.ConfigurationManager.AppSettings["cn2"], EncryptionKey2));
                con4.Open();
                string strcon4 = "delete from job_site_subs where sr=@sr";
